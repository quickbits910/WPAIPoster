...
/// <summary>
/// Ollama client — OpenAI-compatible endpoint at <c>http://127.0.0.1:11434</c> by default.
/// Pass <paramref name="baseUrl"/> to target a different host or port.
/// </summary>
[ExcludeFromCodeCoverage]
public sealed class OllamaClient(HttpClient httpClient, string model, string? baseUrl = null)
    : ILlmClient
{
